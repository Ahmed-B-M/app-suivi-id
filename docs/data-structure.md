...
| Commande | `numeroCommande` | Numéro de commande client (identique à tacheId). | Texte | "619118027" |
...
| Nom Complet Chauffeur | `nomCompletChauffeur` | Prénom et nom du livreur. | Texte | "Alexandre Market Antibes" |
