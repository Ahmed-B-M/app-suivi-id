  ...
  if (value !== null) {
    if (isRate) { // For percentage-based rates
      if (isLowerBetter) { // Lower is better (e.g., forced address rate)
        if (value <= 1) colorClass = "bg-green-700 text-white"; // Excellent
        else if (value <= 2) colorClass = "bg-green-500 text-white"; // Good
        else if (value <= 5) colorClass = "bg-yellow-500 text-black"; // Average
        else if (value <= 10) colorClass = "bg-orange-500 text-white"; // Warning
      ...
      else if (value >= 4.6) colorClass = "bg-yellow-500 text-black"; // Average
      else if (value >= 4.4) colorClass = "bg-orange-500 text-white"; // Warning
      else colorClass = "bg-red-600 text-white"; // Bad
    }
  }
